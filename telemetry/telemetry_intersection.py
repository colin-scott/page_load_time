...
def __main__():
    ...
    local_path = '/home/jamshed/src/tools/perf/page_sets/data/url*.wpr'
    remote_path = '/tmp/'
    ...
    for i in range(len(urls)):
        ...
        for trial in range(NUMBER_OF_TRIALS):
            ...
            files = glob('/home/jamshed/src/tools/perf/page_sets/data/url*.wpr')
            if len(files) != 1:
                raise Exception(
    ...
    [move(f, '/home/jamshed/src/tools/perf/page_sets/data/') for f in remote_files]
